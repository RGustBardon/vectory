 ...
 * @internal
 */
final class NullableUint24VectorBench
{
    ...
    {
        \unserialize($this->serializedInstanceForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\NullableUint24Vector', '\\')]]);
    }
    ...
    {
        return new \Vectory\NullableUint24Vector();
    }
}
