...
final class NullableChar3VectorBench
{
    ...
    {
        $this->instanceForArrayAccessOffsetSetOverwriting[\mt_rand(0, 9999)] = "\0\0\0";
    }
    ...
    {
        $this->instanceForArrayAccessOffsetSetPushingWithoutGap[] = "\0\0\0";
    }
    ...
    {
        $this->instanceForArrayAccessOffsetSetPushingWithGap[$this->lastIndexOfArrayAccessOffsetSetPushingWithGap += 100] = "\0\0\0";
    }
    ...
    {
        $this->instanceForInsertUnshifting->insert(["\0\0\0"], 0);
    }
    ...
    {
        \unserialize($this->serializedInstanceForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\NullableChar3Vector', '\\')]]);
    }
    ...
    private function setUpArrayAccessBenchmark(): void
    {
        ...
        $this->instanceForArrayAccessOffsetGetRandomAccess[9999] = "\0\0\0";
        $this->instanceForArrayAccessOffsetSetOverwriting = self::getInstance();
        $this->instanceForArrayAccessOffsetSetOverwriting[9999] = "\0\0\0";
