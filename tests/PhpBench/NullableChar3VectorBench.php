...
final class NullableChar3VectorBench
{
    ...
    {
        \unserialize($this->serializedVectorForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\NullableChar3Vector', '\\')]]);
    }
    ...
    private function setUpArrayAccessBenchmark(): void
    {
        ...
        $this->vectorForArrayAccessOffsetGetRandomAccess[9999] = "\0\0\0";
        $this->vectorForArrayAccessOffsetSetOverwriting = self::getInstance();
        $this->vectorForArrayAccessOffsetSetOverwriting[9999] = "\0\0\0";
