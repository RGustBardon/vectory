 ...
 * @internal
 */
final class NullableInt16VectorBench
{
    ...
    {
        \unserialize($this->serializedInstanceForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\NullableInt16Vector', '\\')]]);
    }
    ...
    {
        return new \Vectory\NullableInt16Vector();
    }
}
