 ...
 * @internal
 */
final class NullableInt40VectorBench
{
    ...
    {
        \unserialize($this->serializedInstanceForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\NullableInt40Vector', '\\')]]);
    }
    ...
    {
        return new \Vectory\NullableInt40Vector();
    }
}
