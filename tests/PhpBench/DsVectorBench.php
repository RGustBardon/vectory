...
final class DsVectorBench
{
    ...
    {
        $this->instanceForInsertUnshifting->unshift("\0\0");
    }
    ...
    {
        \unserialize($this->serializedInstanceForSerializableUnserialize, ['allowed_classes' => [\ltrim('Ds\\Vector', '\\')]]);
    }
    ...
    public static function getInstance(bool $filled = false): \Ds\Sequence
    {
        ...
        if ($filled) {
            $instance->push(...\array_fill(0, 10000, "\0\0"));
        }
