...
final class NullableChar4VectorBench
{
    ...
    {
        $this->vectorForArrayAccessOffsetSetOverwriting[\mt_rand(0, 9999)] = "\x0\x0\x0\x0";
    }
    ...
    {
        $this->vectorForArrayAccessOffsetSetPushingWithoutGap[] = "\x0\x0\x0\x0";
    }
    ...
    {
        $this->vectorForInsertUnshifting->insert(["\x0\x0\x0\x0"], 0);
    }
    ...
    public function benchSerializableUnserialize(): void
    {
        \unserialize(
            ...
            ['allowed_classes' => [\ltrim('\\Vectory\\NullableChar4Vector', '\\')]]
        );
    }
    ...
    private function setUpArrayAccessBenchmark(): void
    {
        ...
        $this->vectorForArrayAccessOffsetGetRandomAccess[10000] = "\x0\x0\x0\x0";

        $this->vectorForArrayAccessOffsetSetOverwriting = self::getInstance();
        $this->vectorForArrayAccessOffsetSetOverwriting[10000] = "\x0\x0\x0\x0";
