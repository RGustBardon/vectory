...
final class Int56VectorBench
{
    ...
    {
        \unserialize($this->serializedInstanceForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\Int56Vector', '\\')]]);
    }
    ...
    public static function getRandomSignedInteger(bool $negative): int
    {
        ...
        $value = \hexdec($value);
        $value = $negative ? $value < 0 ? -$value : -36028797018963968 : $value;
