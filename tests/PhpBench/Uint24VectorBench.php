...
final class Uint24VectorBench
{
    ...
    {
        \unserialize($this->serializedInstanceForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\Uint24Vector', '\\')]]);
    }
    ...
    {
        return new \Vectory\Uint24Vector();
    }
}
