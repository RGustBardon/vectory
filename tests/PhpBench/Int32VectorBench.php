...
final class Int32VectorBench
{
    ...
    {
        \unserialize($this->serializedInstanceForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\Int32Vector', '\\')]]);
    }
    ...
    public static function getRandomSignedInteger(bool $negative): int
    {
        ...
        $value = \hexdec($value);
        $value = $negative ? $value < 0 ? -$value : -2147483648 : $value;
    ...
    private function setUpArrayAccessBenchmark(): void
    {
        ...
        $this->instanceForArrayAccessOffsetGetRandomAccess[9999] = 0;
        $this->instanceForArrayAccessOffsetSetOverwriting = self::getInstance();
        $this->instanceForArrayAccessOffsetSetOverwriting[9999] = 0;
    ...
    {
        return new \Vectory\Int32Vector();
    }
}
