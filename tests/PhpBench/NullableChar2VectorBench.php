...
final class NullableChar2VectorBench
{
    ...
    {
        $this->vectorForInsertUnshifting->insert(["\x0\x0"], 0);
    }
    ...
    public function benchSerializableUnserialize(): void
    {
        \unserialize(
            ...
            ['allowed_classes' => [\ltrim('\\Vectory\\NullableChar2Vector', '\\')]]
        );
    }
    ...
    private function setUpDeleteBenchmark(): void
    {
        ...
        $this->vectorForDeleteAtHead[10000] = "\x0\x0";

        $this->vectorForDeleteAtTail = self::getInstance();
        $this->vectorForDeleteAtTail[10000] = "\x0\x0";
    }

    private function setUpInsertBenchmark(): void
    {
        $this->batchForInsert = \array_fill(0, 50, "\x0\x0");
