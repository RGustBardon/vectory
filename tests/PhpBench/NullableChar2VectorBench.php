...
final class NullableChar2VectorBench
{
    ...
    {
        $this->vectorForArrayAccessOffsetSetOverwriting[\mt_rand(0, 9999)] = "\0\0";
    }
    ...
    {
        $this->vectorForArrayAccessOffsetSetPushingWithoutGap[] = "\0\0";
    }
    ...
    {
        $this->vectorForArrayAccessOffsetSetPushingWithGap[$this->lastIndexOfArrayAccessOffsetSetPushingWithGap += 100] = "\0\0";
    }
    ...
    {
        $this->vectorForInsertUnshifting->insert(["\0\0"], 0);
    }
    ...
    {
        \unserialize($this->serializedVectorForSerializableUnserialize, ['allowed_classes' => [\ltrim('\\Vectory\\NullableChar2Vector', '\\')]]);
    }

    private function setUpArrayAccessBenchmark(): void
    {
        $this->vectorForArrayAccessOffsetGetRandomAccess = self::getInstance();
        $this->vectorForArrayAccessOffsetGetRandomAccess[10000] = "\0\0";
        $this->vectorForArrayAccessOffsetSetOverwriting = self::getInstance();
        $this->vectorForArrayAccessOffsetSetOverwriting[10000] = "\0\0";
