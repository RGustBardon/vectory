...
class Char1Vector implements VectorInterface
{
    ...
    public function jsonSerialize(): array
    {
        ...
        $elementCount = $this->elementCount;
        for ($getIteratorIndex = 0; $getIteratorIndex < $elementCount; ++$getIteratorIndex) {
            $element = $this->primarySource[$getIteratorIndex];
            $result[] = $element;
        }
    ...
    public function unserialize($serialized)
    {
        ...
        $newValues = \unserialize($serialized, ['allowed_classes' => [\ltrim('\\Vectory\\Char1Vector', '\\')]]);
