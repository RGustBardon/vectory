...
class NullableInt64Vector implements VectorInterface
{
    ...
    public function offsetGet($index)
    {
        ...
        if ($isNull) {
            ...
            $value = \unpack('q', $packedInteger)[1];
        }
    ...
    public function getIterator(): \Traversable
    {
        ...
        foreach (\unpack('q*', $primarySource) as $element) {
            if (0 === ($bitIndex & 7)) {
    ...
    public function unserialize($serialized)
    {
        ...
        $newValues = \unserialize($serialized, ['allowed_classes' => [\ltrim('\\Vectory\\NullableInt64Vector', '\\')]]);
