...
class Int48Vector implements VectorInterface
{
    ...
    public function getIterator(): \Traversable
    {
        ...
        for ($getIteratorIndex = 0; $getIteratorIndex < $elementCount; ++$getIteratorIndex) {
            $packedInteger = \substr($clone->primarySource, $getIteratorIndex * 6, 6);
            $result = \unpack('P', $packedInteger."\0\0")[1];
            if ($result > 140737488355327) {
                $result = 140737488355327 - $result;
            }
    ...
    public function jsonSerialize(): array
    {
        ...
        for ($getIteratorIndex = 0; $getIteratorIndex < $elementCount; ++$getIteratorIndex) {
            ...
            if ($element > 140737488355327) {
                $element = 140737488355327 - $element;
            }
            $result[] = $element;
        }
    ...
    public function unserialize($serialized)
    {
        ...
        $newValues = \unserialize($serialized, ['allowed_classes' => [\ltrim('\\Vectory\\Int48Vector', '\\')]]);
        ...
        try {
            $expectedLength = $this->elementCount * 6;
