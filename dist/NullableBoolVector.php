...
class NullableBoolVector implements VectorInterface
{
    ...
    public function unserialize($serialized)
    {
        ...
        $newValues = \unserialize($serialized, ['allowed_classes' => [\ltrim('\\Vectory\\NullableBoolVector', '\\')]]);
        ...
        foreach ($elements as $element) {
            if (null === $element) {
                ...
                if (true === $element) {
                    ...
                    throw new \TypeError(self::EXCEPTION_PREFIX.\sprintf('Value must be of type %s%s, %s given', 'bool', ' or null', \gettype($element)));
                }
            }
            ++$howManyBitsToInsert;
