...
class NullableInt32Vector implements VectorInterface
{
    ...
    public function offsetGet($index)
    {
        ...
        if ($isNull) {
            ...
            $value = \unpack('l', $packedInteger)[1];
        }
    ...
    public function getIterator(): \Traversable
    {
        ...
        foreach (\unpack('l*', $primarySource) as $element) {
            if (0 === ($bitIndex & 7)) {
    ...
    public function unserialize($serialized)
    {
        ...
        $newValues = \unserialize($serialized, ['allowed_classes' => [\ltrim('\\Vectory\\NullableInt32Vector', '\\')]]);
