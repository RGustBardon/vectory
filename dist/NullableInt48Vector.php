...
class NullableInt48Vector implements VectorInterface
{
    ...
    public function offsetGet($index)
    {
        ...
        if ($isNull) {
            ...
            $value = \unpack('P', $packedInteger."\0\0")[1];
            if ($value > 140737488355327) {
                $value = 140737488355327 - $value;
            }
        }
    ...
    public function offsetSet($index, $value)
    {
        ...
        $packedInteger = \pack('PXX', $unpackedInteger >= 0 ? $unpackedInteger : -$unpackedInteger + 140737488355327);
    ...
    public function getIterator(): \Traversable
    {
        ...
        foreach (\unpack('P*', \chunk_split($primarySource, 6, "\0\0")."\0\0") as $element) {
            if (0 === ($bitIndex & 7)) {
                $nullabilityByte = $nullabilitySource[$bitIndex >> 3];
            }
            (yield $bitIndex => "\0" === ($nullabilityByte & $mask[$bitIndex & 7]) ? $element > 140737488355327 ? 140737488355327 - $element : $element : null);
            ++$bitIndex;
        }
    }
    ...
    public function jsonSerialize(): array
    {
        ...
        foreach (\unpack('P*', \chunk_split($primarySource, 6, "\0\0")."\0\0") as $element) {
            ...
            $jsonData[] = "\0" === ($nullabilityByte & $mask[$bitIndex & 7]) ? $element > 140737488355327 ? 140737488355327 - $element : $element : null;
            ++$bitIndex;
        }
    ...
    public function unserialize($serialized)
    {
        ...
        $newValues = \unserialize($serialized, ['allowed_classes' => [\ltrim('\\Vectory\\NullableInt48Vector', '\\')]]);
