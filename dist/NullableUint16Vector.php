...
class NullableUint16Vector implements VectorInterface
{
    ...
    public function offsetGet($index)
    {
        ...
        if ($isNull) {
            ...
            $value = \unpack('v', $packedInteger)[1];
        }
    ...
    public function offsetSet($index, $value)
    {
        ...
        $packedInteger = \pack('v', $unpackedInteger);
    ...
    public function jsonSerialize(): array
    {
        ...
        for ($getIteratorIndex = 0; $getIteratorIndex < $elementCount; ++$getIteratorIndex) {
            ...
            if ($isNull) {
                ...
                $element = \unpack('v', $packedInteger)[1];
            }
            $result[] = $element;
        }
    ...
    public function unserialize($serialized)
    {
        ...
        $newValues = \unserialize($serialized, ['allowed_classes' => [\ltrim('\\Vectory\\NullableUint16Vector', '\\')]]);
    ...
    public function insert(iterable $elements, int $firstIndex = -1): void
    {
        ...
        $defaultValue = 0;
        $defaultValue = \pack('v', $defaultValue);
        $substringToInsert = '';
        ...
        foreach ($elements as $element) {
            if (null === $element) {
                ...
                if ($element < 0 || $element > 65535) {
                    throw new \OutOfRangeException(self::EXCEPTION_PREFIX.'Value out of range: '.$element.', expected '. 0 .' <= x <= '. 65535);
                }
                $packedInteger = \pack('v', $element);
